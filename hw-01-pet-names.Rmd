...
This assignment assumes that you have attended the first module of the course.
...
In RStudio, click on the **File** and then **New Project** and then choose **Version Control** and then **Git**.

In the next screen, **paste the URL** you copied from GitHub and then click **Create Project**.
...
This should proceed seamlessly if you created your personal access token. If that failed for some reason, then you may need to enter your username and password for Github.
